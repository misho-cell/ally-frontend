...
const en = {
  ...
  homePlaceholder: "Give me a goal. One sentence is enough.",
  ...
  reqAcceptDirect: "Connect them to me directly",
  reqAcceptMediator: "Keep it through me",
  reqDeny: "Decline",
  reqLater: "Remind me later",
  reqAcceptedDirect: "Accepted ✓ they will be put in touch with you directly",
  reqAcceptedMediator: "Accepted ✓ it stays through you, no number is shared",
...
const ka: typeof en = {
  ...
  reqAcceptDirect: "დააკავშირე პირდაპირ",
  reqAcceptMediator: "ჩემი გავლით გააგრძელე",
  reqDeny: "უარი",
  reqLater: "მოგვიანებით შემახსენე",
  reqAcceptedDirect: "მიღებულია ✓ პირდაპირ დაგაკავშირებთ",
  reqAcceptedMediator: "მიღებულია ✓ შენი გავლით გრძელდება, ნომერი არავის გადაეცემა",
