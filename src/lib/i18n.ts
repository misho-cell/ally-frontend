...
const KA_MONTHS = ["იანვარი", "თებერვალი", "მარტი", "აპრილი", "მაისი", "ივნისი", "ივლისი", "აგვისტო", "სექტემბერი", "ოქტობერი", "ნოემბერი", "დეკემბერი"];
...
const ka: typeof en = {
  ...
  requestsHint: "შენი წრიდან თხოვნები აქ გამოჭნდება.",
  threadsHint: "მიზნები ჯერ არ არის, პირველი თხოვნა დაიწყებს ახალს.",
  noMatches: "ძებნას არაფერი ემთხვევა.",
  signOut: "გასვლა",
  selectThread: "აირციე მიზანი ან მომეცე ახალი.",
  emptyHome: "ჯერ არაფერი მაყვს სამუშაო. განმისაზიერე მიზანი, დანარჩენს მე მივხედავ.",
  taskFallback: "ახალი მიზანი",
  threadFallback: "მიზანი",
  hiIntro: "გამარჯობა, მე Netai ვარ",
  giveTaskEmpty: "განმისაზიერე მიზანი, შენი ქსელის დახმარებით ვიმუშავ და მოვაგვარ.",
  composerPlaceholder: "განუსაზიევე Netai-ს მიზანი…",
  listening: "გისმენ…",
  ...
  workingOnIt: "ვმუშაობ…",
  jumpToBottom: "ბოლოში ჭასვლა",
  retry: "თავიდან სცადე",
  stepsToggle: "ნაბიჯები ({n})",
  takingLonger: "ჭვეულებრივზე მეტ დროს იღებს…",
  stillOnIt: "ისევ ვმუშაობ, ეს მძიმე მიზანია.",
  loadFailed: "მიზანი ვერ ჭაიტვირთა.",
  share: "გაზიარება",
  linkCopied: "ლინქი დაკოპირდა",
  tokensAdded: "ტოკენები დაემატა",
  tokensLow: "ტოკენები იწურება",
  tokensAlmostGone: "ტოკენები თითქმის ამოიწურა, დარჭა {n}",
  ...
  renewsOrTopup: "განახლდება: {date}. ან დაამათე ტოკენები ახლავ:",
  subscribe: "გამოწერა",
  ...
  meFallback: "მე",
  send: "გაგზავნა",
  voiceStart: "ხმით ჭაწერა",
  voiceStop: "ჭაწერის გაჭერება",
  backLabel: "უკან",
  profileLink: "პროფილი",
  ...
  reqAccepted: "მიიღებულია ✓ მთხოვნელს ეცნობება",
