...
// Referral Rewards (ticket 6 #5). Copy below is the APPROVED English text.
// The Georgian translation is drafted and pending prompt-team approval — swap
// it in here once confirmed:
  ...
  return (
    <div className="card flex flex-col gap-3">
      ...
      <button type="button" onClick={share} className="btn-primary self-start">
        {copied === "text" ? "Copied!" : "Invite friend"}
      </button>
    </div>
  );
}
